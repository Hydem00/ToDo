...
const listTitle = document.querySelector('#popUpAddList div.modal-content form input');
const listDescription = document.querySelector('#popUpAddList div.modal-content form textarea');
...
document.querySelector('div.popUpAdd div.modal-content form button').addEventListener('click', addListValidation);