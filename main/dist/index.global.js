...
var FullCalendar = (function (exports) {
  ...
  function g$2(n, l, u, i, t) {
    ...
    n: if ("style" === l)
      ...
      (r = l !== (l = l.replace(/Capture$/, ""))),
        ...
        n.l || (n.l = {}),
        (n.l[l + r] = u),
        u ? i || n.addEventListener(l, r ? w$2 : m$1, r) : n.removeEventListener(l, r ? w$2 : m$1, r);
  ...
  function H$1(n, l, u, i, t, r, o, f, e, a) {
    ...
    for (u.__k = [], h = 0; h < l.length; h++)
      if (
        ...
        if (((d.__ = u), (d.__b = u.__b + 1), null === (y = m[h]) || (y && d.key == y.key && d.type === y.type)))
          m[h] = void 0;
        else
          for (v = 0; v < w; v++) {
        ...
        M(n, d, (y = y || c$1), t, r, o, f, e, a),
          (k = d.__e),
          (v = d.ref) && y.ref != v && (g || (g = []), y.ref && g.push(y.ref, null, d), g.push(v, d.__c || k, d)),
          null != k
            ? (null == b && (b = k),
              "function" == typeof d.type && d.__k === y.__k ? (d.__d = e = I$1(d, e, n)) : (e = z$1(n, d, y, m, k, e)),
              "function" == typeof u.type && (u.__d = e))
            : e && y.__e == e && e.parentNode != n && (e = A(y));
      }
    for (u.__e = b, h = w; h--; )
      null != m[h] &&
        ("function" == typeof u.type && null != m[h].__e && m[h].__e == u.__d && (u.__d = L$1(i).nextSibling),
        q(m[h], m[h]));
    if (g) for (h = 0; h < g.length; h++) S(g[h], g[++h], g[++h]);
  }
  function I$1(n, l, u) {
    for (var i, t = n.__k, r = 0; t && r < t.length; r++)
      (i = t[r]) && ((i.__ = n), (l = "function" == typeof i.type ? I$1(i, l, u) : z$1(u, i, i, t, i.__e, l)));
    return l;
  }
  function j$2(n, l) {
    return (
      ...
      n: if ("function" == typeof $) {
        if (
          ...
          null != $.getDerivedStateFromProps &&
            (a.__s == a.state && (a.__s = h({}, a.__s)), h(a.__s, $.getDerivedStateFromProps(b, a.__s))),
          (y = a.props),
          (p = a.state),
          (a.__v = u),
          v)
        )
          null == $.getDerivedStateFromProps && null != a.componentWillMount && a.componentWillMount(),
          ...
          if (
            ...
            (!a.__e && null != a.shouldComponentUpdate && !1 === a.shouldComponentUpdate(b, a.__s, m)) ||
              u.__v === i.__v)
          ) {
            for (
        ...
        if (
          ((a.context = m), (a.props = b), (a.__P = n), (A = l$1.__r), (P = 0), "prototype" in $ && $.prototype.render)
        ) {
          for (
            a.state = a.__s, a.__d = !1, A && A(u), s = a.render(a.props, a.state, a.context), C = 0;
            C < a._sb.length;
            C++
          )
            a.__h.push(a._sb[C]);
        ...
        null == o && u.__v === i.__v ? ((u.__k = i.__k), (u.__e = i.__e)) : (u.__e = O(i.__e, u, i, t, r, o, f, c));
      (s = l$1.diffed) && s(u);
    } catch (n) {
  ...
  function O(l, u, i, t, r, o, f, e) {
    ...
    if (null === d) y === p || (e && l.data === p) || (l.data = p);
      ...
      if (
        ...
        (h || a) &&
          ((h && ((a && h.__html == a.__html) || h.__html === l.innerHTML)) || (l.innerHTML = (h && h.__html) || ""));
      }
      if ((k$1(l, p, y, r, e), h)) u.__k = [];
      else if (
        ((_ = u.props.children),
        H$1(l, Array.isArray(_) ? _ : [_], u, i, t, r && "foreignObject" !== d, o, f, o ? o[0] : i.__k && A(i, 0), e),
        null != o)
      )
      ...
      e ||
        ...
        "checked" in p && void 0 !== (_ = p.checked) && _ !== l.checked && g$2(l, "checked", _, y.checked, !1));
    }
    return l;
  }
  function S(n, u, i) {
  ...
  (n = s.slice),
    ...
    (r$1 = []),
    (f$1 = "function" == typeof Promise ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout),
    ($$1.__r = 0),
    (e$1 = 0);
    ...
    render() {
      ...
      if (customGenerator != null) {
        const customGeneratorRes =
          typeof customGenerator === "function" ? customGenerator(renderProps, y) : customGenerator;
  ...
  class ContentContainer extends x$1 {
    ...
    componentDidMount() {
      ...
      (_b = (_a = this.props).didMount) === null || _b === void 0
        ? void 0
        : _b.call(_a, Object.assign(Object.assign({}, this.props.renderProps), { el: this.rootEl || this.base }));
    }
    componentWillUnmount() {
      var _a, _b;
  ...
  class SimpleScrollGrid extends BaseComponent {
    ...
    render() {
      ...
      return y(
        ...
        Boolean(!isBuggy && headSectionNodes.length) && y("thead", roleAttrs, ...headSectionNodes),
        Boolean(!isBuggy && bodySectionNodes.length) && y("tbody", roleAttrs, ...bodySectionNodes),
        Boolean(!isBuggy && footSectionNodes.length) && y("tfoot", roleAttrs, ...footSectionNodes),
        isBuggy && y("tbody", roleAttrs, ...headSectionNodes, ...bodySectionNodes, ...footSectionNodes)
      );
    }
  ...
  function shouldDisplayMonthStart(date, currentRange, dateEnv) {
    ...
    return (
      !(currentFirstYear === currentLastYear && currentFirstMonth === currentLastMonth) &&
      Boolean(
  ...
  class TimeBodyAxis extends BaseComponent {
    render() {
      return this.props.slatMetas.map((slatMeta) =>
        y("tr", { key: slatMeta.key }, y(TimeColsAxisCell, Object.assign({}, slatMeta)))
      );
    }
  }
          ...
          chunks: [
            {
              ...
              rowContent: (contentArg) =>
                y("tr", { role: "presentation" }, this.renderTableRowAxis(contentArg.rowSyncHeights[0])),
            },
            {
              key: "cols",
  ...
  class DayTimeCols extends DateComponent {
    ...
    render() {
      ...
      return y(NowTimer, { unit: nowIndicator ? "minute" : "day" }, (nowDate, todayRange) =>
        y(
          TimeCols,
          Object.assign(
            ...
            this.slicer.sliceProps(props, dateProfile, null, context, dayRanges),
            {
              ...
              nowDate: nowDate,
              nowIndicatorSegs:
                nowIndicator && this.slicer.sliceNowDate(nowDate, dateProfile, nextDayThreshold, context, dayRanges),
              todayRange: todayRange,
      ...
      return y(
        ...
        (
          ...
          y(
            ...
            y(InnerContent, { elTag: "div", elClasses: ["fc-list-day-cushion", theme.getClass("tableCellShaded")] })
          )
      );
    }
  }
  function renderInnerContent(props) {
    return y(
      ...
      null,
      props.text &&
        y("a", Object.assign({ id: props.textId, className: "fc-list-day-text" }, props.navLinkAttrs), props.text),
      props.sideText &&
  ...
  class MultiMonthView extends DateComponent {
    ...
    render() {
      ...
      const colCount =
        Math.min(
          clientWidth != null ? Math.floor(clientWidth / (options.multiMonthMinWidth + monthHPadding)) : 1,
      ...
      return y(
        ViewContainer,
        { elRef: this.scrollElRef, elClasses: rootClassNames, viewSpec: context.viewSpec },
    ...
    flushScrollReset() {
      if (
        ...
        scrollEl.scrollTop =
          monthEl.getBoundingClientRect().top - this.firstMonthElRef.current.getBoundingClientRect().top;
        this.needsScrollReset = false;
      }
    }
